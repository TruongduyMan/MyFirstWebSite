...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.HangHoa", b =>
                {
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.HangHoaTag", b =>
                {
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.HinhPhu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.Review", b =>
                {
                    b.Property<int>("IdR")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.ReviewHangHoa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.Tag", b =>
                {
                    b.Property<string>("TagKey")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.HangHoa", b =>
                {
                    b.HasOne("MyFirstWebSite.Data.Loai", "Loai")
                        .WithMany("HangHoas")
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.HangHoaTag", b =>
                {
                    b.HasOne("MyFirstWebSite.Data.HangHoa", "HangHoa")
                        .WithMany("HangHoaTags")
                        .HasForeignKey("MaHangHoa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyFirstWebSite.Data.Tag", "Tag")
                        .WithMany("HangHoaTags")
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.Loai", b =>
                {
                    b.HasOne("MyFirstWebSite.Data.Loai", "LoaiCha")
                        .WithMany()
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.Review", b =>
                {
                    b.HasOne("MyFirstWebSite.Data.HangHoa", null)
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("MyFirstWebSite.Data.ReviewHangHoa", b =>
                {
                    ...
                    b.HasOne("MyFirstWebSite.Data.Review", "Review")
                        .WithMany("ReviewHangHoas")
